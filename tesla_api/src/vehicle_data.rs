...
impl Default for VehicleData {
    fn default() -> Self {
        Self {
            ...
            vehicle_id: Option::default(),
            vin: Option::default(),
            display_name: Option::default(),
            option_codes: Option::default(),
            color: Option::default(),
            access_type: Option::default(),
            tokens: Option::default(),
            state: Option::default(),
            in_service: Option::default(),
            id_s: Option::default(),
            calendar_enabled: Option::default(),
            api_version: Option::default(),
            backseat_token: Option::default(),
            backseat_token_updated_at: Option::default(),
            ble_autopair_enrolled: Option::default(),

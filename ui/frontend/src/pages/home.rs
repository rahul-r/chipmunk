    ...
    view! {
        <div class="flex flex-row w-full bg-white md:border md:border-gray-200 md:rounded-lg shadow md:max-w-md dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="flex flex-col p-5 leading-normal text-center w-full">
                ...
                //     <span class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white inline-block align-top">My Car</span>
                //     <span class="text-sm text-gray-900 dark:text-gray-500">Model 3 LR Performance</span>
                // </div>
                // <div class="space-y-0">
                ...
                <div class="flex items-center justify-center">
                    <p class="pr-2 text-2xl font-bold text-gray-900 dark:text-white">Title</p>
                    <svg fill="currentColor" viewBox="0 0 8 8" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg" class="size-5">
                ...
                <p class="font-thin text-gray-700 dark:text-gray-400">Sub title</p>
                <p class="font-thin text-gray-700 dark:text-gray-400">for i in range(87)</p>
                </div>
                <div class="flex justify-evenly pb-4 text-center">
                <div class="pb-2 text-center">
                    <p class="font-normal text-gray-500 dark:text-gray-500">Battery / Range</p>
                    <p class="text-xl font-normal text-gray-900 dark:text-white">35% / 150mi</p>
                </div>
                <div class="pb-2 text-center">
                    <p class="font-normal text-gray-500 dark:text-gray-500">Odometer</p>
                    <p class="text-xl font-normal text-gray-900 dark:text-white">{status.vehicle.odometer}</p>
                </div>
                </div>
                <div class="flex justify-evenly text-center">
                <div class="pb-2 text-center">
                    <p class="font-normal text-gray-500 dark:text-gray-500">Interior</p>
                    <p class="text-xl font-normal text-gray-900 dark:text-white">"65°F"</p>
                </div>
                <div class="pb-2 text-center">
                    <p class="font-normal text-gray-500 dark:text-gray-500">Exterior</p>
                    <p class="text-xl font-normal text-gray-900 dark:text-white">"67°F"</p>
                </div>
                <div class="flex flex-col items-center pb-2 text-center">
                    <p class="font-normal text-gray-500 dark:text-gray-500">Climate</p>
                    <svg fill="currentColor" viewBox="0 0 24 24" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg" class="size-6">
                    ...
                    <svg fill="currentColor" viewBox="0 0 512 512" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg">
                    <path
